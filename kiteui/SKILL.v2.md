...
| [reactivity.md](reactivity.md) | Signal, remember, rememberSuspending, reactive, forEach, bindings, lens extensions |
...
2. **reactive adds views on every rerun** - use `clearChildren()` first, or prefer `shownWhen`/`forEach`
